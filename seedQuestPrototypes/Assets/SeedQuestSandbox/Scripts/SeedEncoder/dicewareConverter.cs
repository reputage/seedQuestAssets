...
{
    // These functions are derived from another BIP39 library.
    // to do: get actions directly from word list: currently 'processIntToBitsThenBytes' ignores the final 4 bits of the words
    ...
    public void testGetActions()
    {
        ...
        byte[] bytes = processIntToBitsThenBytes(indeces);
        List<int> wordListSizes = new List<int> { 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11 };
