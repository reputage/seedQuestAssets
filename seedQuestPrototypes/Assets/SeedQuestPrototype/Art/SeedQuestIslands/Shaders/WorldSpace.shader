...
Shader "Amplify/WorldSpace"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 lerpResult15 = lerp( UnpackNormal( tex2D( _Base_Normal, uv_Base_Normal ) ) , UnpackNormal( tex2D( _Top_Normal, uv_Top_Normal ) ) , (( blendOpSrc70 > 0.5 ) ? max( blendOpDest70, 2.0 * ( blendOpSrc70 - 0.5 ) ) : min( blendOpDest70, 2.0 * blendOpSrc70 ) ));
			...
			float4 lerpResult10 = lerp( ( tex2D( _Base_Diffuse, uv_Base_Diffuse ) * _Base_Color ) , ( float4( UnpackNormal( tex2D( _Top_Diffuse, uv_Top_Diffuse ) ) , 0.0 ) * _TopColor ) , ( newWorldNormal19.y * _NormalPower ));
			...
			float4 lerpResult72 = lerp( tex2D( _Emissions, uv_Emissions ) , temp_cast_2 , newWorldNormal19.y);
...
/*ASEBEGIN
Version=16200
402;-1413;2191;1350;2831.244;240.0284;1.063521;True;True
Node;AmplifyShaderEditor.CommentaryNode;56;-2351.613,-143.124;Float;False;1225.563;1119.413;Normals;9;14;15;4;70;69;71;21;20;12;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-2293.085,163.5315;Float;False;Property;_NormalPower;NormalPower;5;0;Create;True;0;0;False;0;0.13;1.7;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;14;-2286.392,586.0786;Float;True;Property;_Top_Normal;Top_Normal;2;1;[Normal];Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;4;-2287.455,283.9167;Float;True;Property;_Base_Normal;Base_Normal;8;1;[Normal];Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-22.00563,-680.5269;Float;False;Property;_Fres_Scale_Power;Fres_Scale_Power;13;0;Create;True;0;0;False;0;0;3.18;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;48;24.86219,-593.148;Float;False;Property;_Fres_Power;Fres_Power;12;0;Create;True;0;0;False;0;0;5.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-15.70566,-774.6268;Float;False;Property;_Fres_Bias_Power;Fres_Bias_Power;14;0;Create;True;0;0;False;0;0;0.04;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;28;-1491.441,-923.6116;Float;False;Property;_Base_Color;Base_Color;6;0;Create;True;0;0;False;0;0,0,0,0;0.5566037,0.5566037,0.5566037,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;62;381.1696,-446.5258;Float;False;Property;_EmissionPower;EmissionPower;16;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;37;-635.8342,431.6859;Float;True;Property;_Base_Spec;Base_Spec;10;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;33;-1573.38,-1145.245;Float;True;Property;_Base_Diffuse;Base_Diffuse;7;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;29;-562.3416,1074.596;Float;False;Property;_Top_Spec_Color;Top_Spec_Color;3;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;30;-557.4515,642.6074;Float;False;Property;_Base_Spec_Color;Base_Spec_Color;9;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;38;-634.3004,839.5824;Float;True;Property;_Top_Spec;Top_Spec;4;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;27;-1498.331,-464.1061;Float;False;Property;_TopColor;TopColor;0;0;Create;True;0;0;False;0;0,0,0,0;0.5887327,0.6603774,0.6230097,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;58;296.9256,-640.1081;Float;True;Property;_Emissions;Emissions;15;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;50;274.5028,-1051.331;Float;False;Property;_FresnelColor;FresnelColor;11;0;Create;True;0;0;False;0;0,0,0,0;0.3773583,0.3773583,0.3773583,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;35;-1563.714,-690.4111;Float;True;Property;_Top_Diffuse;Top_Diffuse;1;0;Create;True;0;0;False;0;None;None;True;0;True;white;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;-1226.82,-582.469;Float;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=157D25213C496D62C0045365CA627676CCD0132A