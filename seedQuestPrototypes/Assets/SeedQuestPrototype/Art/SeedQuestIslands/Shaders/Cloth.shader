...
Shader "Amplify/Cloth"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( ( (( _AnimScale * -1.0 ) + (simplePerlin2D25 - 0.0) * (_AnimScale - ( _AnimScale * -1.0 )) / (1.0 - 0.0)) * tex2Dlod( _TextureSample1, float4( panner37, 0, 0.0) ) ) * v.color.r ).rgb;
		}
...
/*ASEBEGIN
Version=16200
-776;-1424;2082;1320;1809.142;112.4194;1;True;True
Node;AmplifyShaderEditor.TimeNode;28;-2035.422,354.2092;Float;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;30;-2008.021,617.7091;Float;False;Property;_AnimSpeed;AnimSpeed;3;0;Create;True;0;0;False;0;0;2.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-1033.142,783.5806;Float;False;Property;_Speed;Speed;6;0;Create;True;0;0;False;0;0;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-1540.12,785.8097;Float;False;Property;_AnimScale;AnimScale;4;0;Create;True;0;0;False;0;0;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PannerNode;37;-886.1423,785.5806;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TFHCRemapNode;32;-1009.721,360.7111;Float;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;36;-751.1423,557.5806;Float;True;Property;_TextureSample1;Texture Sample 1;5;0;Create;True;0;0;False;0;None;9789d23040cb1fb45ad60392430c3c15;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;1;-663.8474,-189.1055;Float;False;Property;_Color0;Color 0;1;0;Create;True;0;0;False;0;1,1,1,1;0.5660378,0.5660378,0.5660378,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;-377.1423,326.5806;Float;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-88.82764,415.0582;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=092BBD7D3FB813641CBDC3F1B5A3EEDC9E0DEA29